...
export default function VaccinationDashboard() {
  ...
  return <main className="vaccination-page"><AppHeader /><section className="content vaccination-content" id="vacunaciones">
    ...
    <section className="intro"><div><p className="eyebrow">Control preventivo</p><h2>Vacunas al día, pacientes protegidos.</h2><p>Revisa las próximas dosis y atiende los vencimientos de la clínica.</p></div><button className="primary-button vaccination-add-button" type="button" onClick={() => setIsFormOpen(true)}><span className="material-symbols-outlined">add_circle</span>Agregar</button></section>
